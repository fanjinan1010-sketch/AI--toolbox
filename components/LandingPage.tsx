    ...
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#F5F7F9]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        <button 
          ...
          className="group relative bg-white border border-slate-200 rounded-lg p-8 text-left shadow-sm hover:shadow-2xl hover:border-[#3B5BFF] hover:-translate-y-1 transition-all duration-300 overflow-hidden"
        >
          ...
          <div className="w-16 h-16 bg-blue-50 rounded-lg flex items-center justify-center mb-6 group-hover:bg-[#3B5BFF] transition-colors duration-300">
