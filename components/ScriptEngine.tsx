      ...
      <div className="flex items-center justify-end relative">
        ...
        <div className="relative" onMouseEnter={() => { if (hasBookInfo && !shouldShowHistoryMode) { if (dropdownTimer.current) window.clearTimeout(dropdownTimer.current); setShowDropdown(true); } }} onMouseLeave={() => { dropdownTimer.current = window.setTimeout(() => setShowDropdown(false), 200); }}>
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 bg-[#3B5BFF]/5 text-[#3B5BFF] border border-[#3B5BFF]/20 rounded-lg text-sm font-bold transition-all active:scale-95 shadow-sm ${shouldShowHistoryMode ? 'bg-[#3B5BFF]/10 border-[#3B5BFF]/40 shadow-blue-500/10' : 'hover:bg-[#3B5BFF]/10'}`}
          >
